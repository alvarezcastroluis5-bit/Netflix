    ...
    body:`
      <div class="netflix-account-validation">
        ...
        <div>
          ...
          <h3>Confirma que la cuenta está a tu nombre</h3>
          <p>
            Después de validar se abrirá JP Streaming automáticamente.
          </p>
        </div>
      </div>
