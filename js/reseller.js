...
function bindActions(){$("#openNetflixService")?.addEventListener("click",openNetflix);$("#openSpotifyService")?.addEventListener("click",()=>openAccounts("spotify"));$("#openCreateDistributor")?.addEventListener("click",createDistributorModal);$("#openCreateClient")?.addEventListener("click",createClientModal);$("#openCreateTicket")?.addEventListener("click",createTicketModal);$("#accountSearch")?.addEventListener("input",renderAccounts);$("#accountServiceFilter")?.addEventListener("change",renderAccounts);$("#profileAvatarFile")?.addEventListener("change",previewAvatar);$("#saveProfilePhoto")?.addEventListener("click",saveProfilePhoto);$("#saveSettings")?.addEventListener("click",saveSettings);$("#notificationBell")?.addEventListener("click",openNotifications);$("#viewAllNotifications")?.addEventListener("click",openNotifications);}
