console.info("Centro Premium core V6.9.7 cargado");
console.info("Centro Premium Netflix V6.9.5 cargado");
...
export function openNetflixIntegrated() {
      ...
      <section class="netflix-native-shell">
        <div class="netflix-native-hero">
          ...
          <div>
            ...
            <p>
              Sigue los cuatro pasos para procesar la operación.
            </p>
          </div>
        </div>
  ...
  processButton.onclick=async()=>{
    ...
    try{
      ...
      processButton.textContent="Procesar solicitud";
