console.info("Centro Premium reseller V6.9.19.21 cargado");
import {supabase,$,$$,escapeHtml,formatDate,statusLabel,statusTone,serviceLabel,serviceBadge,toast,openModal,showSection,wireNavigation,setupLogin,callUserManager,callPublicUserManager,parseEmailBlock,uploadPublicImage,loadNotifications,updateNotificationBadge,showNotificationsModal,renderPersistentNotificationAlert,maybeShowBrowserNotifications,startNotificationWatcher,openNetflixIntegrated} from "./core-6.9.19.js?v=6.9.19.21";
...
async function loadHelpArticles(){
  ...
  // El mapa de distribuidores se publica en una página independiente.
  // No se carga ni se muestra dentro del panel de distribuidores.
  state.countryDistributors=[];
