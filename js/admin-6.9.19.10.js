console.info("Centro Premium admin V6.9.19.17 cargado");
    ...
    return `
      <article class="help-admin-card" data-help-card="${article.id}">
        ...
        <div class="help-admin-media-summary">
          ...
          ${article.show_country_map?`<span class="status-pill cyan">Mapa mundial activo</span>`:""}
        </div>
        <div class="help-admin-actions">
          ${article.show_country_map?`<button type="button" class="action-button cyan" data-help-country-map="${article.id}">🌍 Gestionar mapa</button>`:""}
...
async function countryMapManagerModal(articleId){
  ...
  const modal=openModal({
    ...
    body:`
      <div class="notice-box">
        Selecciona un país, registra al distribuidor oficial y coloca su WhatsApp con código internacional. Los demás usuarios solo podrán consultar el mapa y contactar al distribuidor.
      </div>
