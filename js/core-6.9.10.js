console.info("Centro Premium core V6.9.10 cargado");
...
export function openNetflixIntegrated() {
      ...
      <section class="netflix-clean-shell">
        <div class="netflix-native-hero">
          ...
          <div>
            ...
            <p>
              Valida el correo, selecciona la operación y abre Netflix.
            </p>
          </div>
        </div>
        ...
        <div class="netflix-native-steps">
          <div
            class="netflix-native-step active"
            data-netflix-step="1"
          >
            <span>1</span>
        ...
        >
          ...
          <div
            id="netflixCleanValidation"
            class="netflix-native-validation"
            hidden
          ></div>

          <fieldset
            id="netflixCleanActions"
        ...
        <section
          id="netflixCleanAccess"
          class="netflix-clean-access"
          hidden
        >
          <div class="netflix-clean-access-heading">
            <div>
              ...
              <p>
                Copia el PIN y el correo antes de abrir Netflix.
              </p>
            </div>
          ...
          <div class="netflix-clean-copy-grid">
            <article class="netflix-clean-copy-card">
              ...
              <strong
                id="netflixCleanPin"
                class="netflix-clean-code"
              >
                ${NETFLIX_GENERAL_PIN}
              </strong>

              <button
                id="copyNetflixCleanPin"
                class="btn secondary"
                type="button"
              >
                Copiar PIN
            ...
            <article class="netflix-clean-copy-card">
              ...
              <strong
                id="netflixCleanEmail"
                class="netflix-clean-email"
              ></strong>

              <button
                id="copyNetflixCleanEmail"
                class="btn secondary"
                type="button"
              >
                Copiar correo
  ...
  const validateButton=$(
    "#validateNetflixClean",
    modal.root
  );
  const validation=$(
    "#netflixCleanValidation",
    modal.root
  );
  const actionsBox=$(
    "#netflixCleanActions",
  ...
  async function validateProperty(){
    ...
    try{
      ...
      validation.innerHTML=`
        <strong>
          ✓ 2. Propiedad validada correctamente
        </strong>
      ...
      toast(
        "Propiedad de la cuenta validada."
      );
    }catch(error){
      clearValidation();
      ...
      validation.innerHTML=`
        <strong>
          No se pudo validar la propiedad
        </strong>
  ...
  openButton.onclick=async()=>{
    ...
    await copyText(
      NETFLIX_GENERAL_PIN,
      "PIN copiado. Abriendo Netflix..."
    );

    const opened=window.open(
      NETFLIX_TOOL_URL,
      "centro_premium_netflix_access"
    );
